...
export default function SignUp() {
  ...
  const handleMouseDownPassword = (event) => {
    ...
    return (
        <div>
            <p>
            <TextField id="standard-basic" error={usernameError} label="Username" value={usernameInput} onChange={(event) => setusernameInput(event.target.value)} onBlur={handleusername} variant="standard" fullWidth size="small" />
            </p>
